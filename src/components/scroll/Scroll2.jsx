...
import './scoll2.css'; // Assuming this is your CSS file for styles
...
const LogoCarousel2 = () => {
  ...
  return (
    <div className="mask w-full h-28 bg-black inline-flex flex-nowrap overflow-hidden ">
      <ul ref={logosRef} className="flex bg-black items-center justify-center aanimate-infinite-scroll">
